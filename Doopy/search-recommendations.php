...
<head>
    ...
    <title>Doopy-recommendations</title>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-star fa-fw"></i> Recommendations</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-left">
                                <div class="huge">Recommended Material</div>
                            </div>
                        </div>
                    </div>
                    <a href="#">
          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="panel panel-default">
                      <div class="panel-heading">
                      <!--  <i>Sort by:  </i> -->
                        <a href="search-recommendations.php?whereStatement=Math" class="btn btn-social-icon btn-bitbucket"><i class="fa fa-calculator"></i></a>
                        <i>Math</i>
                        <a href="search-recommendations.php?whereStatement=History"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-institution"></i></a>
                        <i>History</i>
                        <a href="search-recommendations.php?whereStatement=Swedish"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-language"></i></a>
                        <i>Swedish</i>
                        <a href="search-recommendations.php?whereStatement=English"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-language"></i></a>
                        <i>English</i>
                        <a href="search-recommendations.php?whereStatement=Geography"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-globe"></i></a>
                        <i>Geography</i>
                          ...
                          <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                    ...
                                    $sql = "SELECT DISTINCT content.content_id, content_name, publisher, content_type, subject, subcategory, target_group, Rating, Views, created FROM content $where ORDER BY ABS(Rating) DESC LIMIT 15";
