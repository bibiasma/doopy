...
<head>
    ...
    <title>Doopy-Search-Categories</title>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-left">
                                <div class="huge">Category: Algebra</div>
                            </div>
                        </div>
                    </div>
                    <a href="#">
                          ...
                          <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                    ...
                                    $sql = "SELECT content.content_id, content_name, publisher, content_type, subject, subcategory, target_group, Rating, Views, created FROM content WHERE subcategory='algebra' ORDER BY created DESC";
