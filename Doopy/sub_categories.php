...
<head>
    ...
    <title>Doopy-search-subcategories</title>
                      ...
                      <div class="panel-heading">
                          <div class="row">
                              ...
                              <div class="col-xs-9 text-left">
                                  <div class="huge">Sub-Categories</div>
                              </div>
                          </div>
                      </div>
                      <a href="#">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="panel panel-infon">
                        ...
                        <p>Description about All</p>
                          </div>
                        <div class="panel-footer">
                            <a href="#" <p>Search by All</p></a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-4 -->
                <div class="col-lg-4">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          <p>Description about Algebra</p>
                          </div>
                        <div class="panel-footer">
                            <a href="search-sub-categories-algebra.php">Search by Algebra</a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-4 -->
                <div class="col-lg-4">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                          <p>Description about Statistics</p>
                        </div>
                        <div class="panel-footer">
                            <a href="#" <p>Search by Statistics</p></a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-4 -->
                <div class="col-lg-4">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                          <p>Description about Equations</p>
                        </div>
                        <div class="panel-footer">
                            <a href="#" <p>Search by Equations</p></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="panel panel-infon">
                        ...
                        <div class="panel-body">
                          <p>Description about Prime Numbers</p>
                        </div>
                        <div class="panel-footer">
                            <a href="#" <p>Search by Prime Numbers</p></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                          <p>Description about Negative Numbers</p>
                          </div>
                        <div class="panel-footer">
                            <a href="#" <p>Search by Negative Numbers</p></a>
                        </div>
                    </div>
                </div>
            </div>
