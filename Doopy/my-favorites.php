                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-left">
                                <div class="huge">My Favorites</div>
                            </div>
                        </div>
                    </div>
                    <a href="#">
                          ...
                          <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                    ...
                                    $sql2 = "SELECT playlist.playlist_id, playlist_name FROM playlist WHERE playlist_id !=47 AND playlist_id !=48";
                                        ...
                                        <th><ul class="nav navbar-top-links navbar-right">
                                          ...
                                          <li class="dropdown">
                                              ...
                                              <ul class="dropdown-menu dropdown-user">
                                                  ...
                                                  <?php } } ?>
                                                  <li class="divider"></li>
                                                  <li> <a href="updateTable.php?playlist_id=<?php echo $myid;?>&operation=delete&content_id=<?php echo $content_id;?>&connection=<?php echo $connection_id;?>"><i class="fa fa-close fa-fw"></i> Delete</a>
                                                  </li>
                                              </ul>
                                              <!-- /.dropdown-user -->
                                          </li>
