          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="panel panel-default">
                      <div class="panel-heading">
                      <!--  <i>Sort by:  </i> -->
                        <a href="search-discover.php?whereStatement=Math" class="btn btn-social-icon btn-bitbucket"><i class="fa fa-calculator"></i></a>
                        <i>Math</i>
                        <a href="search-discover.php?whereStatement=History"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-institution"></i></a>
                        <i>History</i>
                        <a href="search-discover.php?whereStatement=Swedish"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-language"></i></a>
                        <i>Swedish</i>
                        <a href="search-discover.php?whereStatement=English"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-language"></i></a>
                        <i>English</i>
                        <a href="search-discover.php?whereStatement=Geography"class="btn btn-social-icon btn-bitbucket"><i class="fa fa-globe"></i></a>
                        <i>Geography</i>
                          ...
                          <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                    ...
                                    $sql = "SELECT content.content_id, content_name, publisher, content_type, subject, subcategory, target_group, Rating, Views, created FROM content $where ORDER BY created DESC";
